---
title: Using OpenAI API Key in mAI
description: >-
  Learn how to configure and use your OpenAI API Key in mAI, supporting
...
<Image alt={'Using OpenAI in mAI'} cover src={'/blog/assets17870709/c9e5eafc-ca22-496b-a88d-cc0ae53bf720.webp'} />

This guide will walk you through how to use [OpenAI](https://openai.com/) in mAI:
...
'https://github-production-user-asset-6210df.s3.amazonaws.com/28616219/296255167-f2745f2b-f083-4ba8-bc78-9b558e0002de.png'
  ...
  ### Step 2: Configure OpenAI in mAI
...
That’s it! You’re now ready to use OpenAI models in mAI for conversations.
