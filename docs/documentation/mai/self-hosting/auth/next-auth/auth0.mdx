---
title: Configure Auth0 Identity Verification Service for mAI
description: >-
  Learn how to configure Auth0 Identity Verification Service for mAI for
...
<Steps>
  ...
  Click on the "Users Management" in the left navigation bar to enter the user management interface, where you can create users for your organization to log in to mAI.
...
<Callout type={'warning'}>
  ...
  mAI being abused by external users.
</Callout>
