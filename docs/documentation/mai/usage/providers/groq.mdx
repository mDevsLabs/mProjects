---
title: Using the Groq API Key in mAI
description: >-
  Learn how to obtain a GroqCloud API Key and configure Groq in mAI to
...
This guide will walk you through how to use Groq in mAI:
...
<Steps>
  ...
  ### Step 2: Configure Groq in mAI

  Go to `Settings` -> `AI Providers` in mAI, and find the configuration section for Groq. Paste the API Key you just obtained.

  <Image alt={'Groq Provider Settings'} height={274} inStep src={'/blog/assets34400653/88948a3a-6681-4a8d-9734-a464e09e4957.webp'} />
</Steps>

Next, in the assistant’s model selection menu, choose a model supported by Groq to start experiencing Groq’s powerful performance in mAI.
