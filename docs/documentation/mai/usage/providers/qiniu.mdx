---
title: Using Qiniu Cloud's Large Language Model API Key in mAI
description: >-
  Learn how to configure and use Qiniu Cloud's large language models in mAI
...
# Using Qiniu Cloud's Large Language Model in mAI

<Image alt={'Using Qiniu Cloud LLM in mAI'} cover src={'/blog/assets48b5c19e20fb870c7bdd34bd3aefbb21.webp'} />
...
This guide will walk you through how to use Qiniu Cloud's large language models in mAI:
...
<Steps>
  ...
  ### Step 2: Configure Qiniu Cloud LLM Service in mAI
...
That's it! You're now ready to use Qiniu Cloud's large language models in mAI for intelligent conversations.
