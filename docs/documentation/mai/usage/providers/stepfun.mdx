---
title: Using the Stepfun API Key in mAI
description: >-
  Learn how to configure and use Stepfun's AI models in mAI, including how
...
# Using Stepfun in mAI

<Image alt={'Using Stepfun in mAI'} cover src={'/blog/assets34400653/95717e2b-1a55-4fca-a96b-b1c186ed4563.webp'} />
...
This guide will walk you through how to use Stepfun in mAI:
...
<Steps>
  ...
  ### Step 2: Configure Stepfun in mAI
...
And that’s it! You’re now ready to start chatting with AI models powered by Stepfun in mAI.
