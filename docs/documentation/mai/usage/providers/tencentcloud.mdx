---
title: Using Tencent Cloud API Key in mAI
description: >-
  Learn how to configure and use Tencent Cloud AI models in mAI, obtain your
...
# Using Tencent Cloud in mAI

<Image alt={'Using Tencent Cloud in mAI'} cover src={'/blog/assetsf625540e8340bafe69ccbb89ad75707a.webp'} />
...
This guide will walk you through how to integrate Tencent Cloud's AI models into mAI:
...
<Steps>
  ...
  ### Step 2: Configure Tencent Cloud in mAI

  - Open mAI and go to App Settings > AI Service Providers.
...
That's it! You’re now ready to use Tencent Cloud’s AI models in mAI for conversations.
