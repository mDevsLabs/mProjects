---
title: Using Fireworks AI in mAI
description: >-
  Learn how to configure and use Fireworks AI's API Key in mAI to start
...
This guide will walk you through how to use Fireworks AI within mAI.
...
<Steps>
  ...
  ### Step 2: Configure Fireworks AI in mAI
...
And that’s it! You’re now ready to start using Fireworks AI models in mAI for conversations and interactions.
