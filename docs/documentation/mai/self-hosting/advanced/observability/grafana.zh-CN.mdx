...
description: >-
  使用 Grafana、Prometheus 指标和 Tempo 链路追踪，监控和分析你的 mAI
...
2. 使用如下命令启动服务：
   ...
   这将会启动 Grafana、Prometheus、Tempo、otel-collector 以及 mAI、Casdoor、Minio 等高级服务。
...
- 检查 Prometheus 和 Tempo 是否正常采集 mAI 及 otel-collector 的数据。
