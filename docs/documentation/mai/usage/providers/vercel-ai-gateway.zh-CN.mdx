---
title: 在 mAI 中使用 Vercel AI Gateway
description: 了解如何在 mAI 中集成和使用 Vercel AI Gateway 的统一 API
tags:
  - mAI
  - Vercel AI Gateway
  - API 密钥
...
<Steps>
  ...
  ### 第二步：在 mAI 中配置 Vercel AI Gateway
...
至此，您可以在 mAI 中使用 Vercel AI Gateway 提供的模型开始聊天了。
