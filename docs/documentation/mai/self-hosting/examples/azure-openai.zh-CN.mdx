---
title: 在 mAI 中集成 Azure OpenAI
description: 了解如何在 mAI 中配置 Azure OpenAI。一步步指导从界面配置到部署时的环境变量设置。
tags:
  - Azure OpenAI
  - 配置指南
  - 使用限制
...
mAI 支持使用 [Azure OpenAI](https://learn.microsoft.com/zh-cn/azure/ai-services/openai/concepts/models) 作为 OpenAI 的模型服务商，本文将介绍如何配置 Azure OpenAI。
