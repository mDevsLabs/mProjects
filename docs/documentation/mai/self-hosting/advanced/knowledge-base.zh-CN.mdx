---
title: mAI 知识库 / 文件上传
description: 了解 mAI 的文件上传和知识库管理核心组件，助力成功部署。
tags:
  - mAI
  - 文件上传
  - 知识库管理
...
mAI 支持文件上传 / 知识库管理。该功能依赖于以下核心技术组件，了解这些组件将有助于你成功部署和维护知识库系统。
...
<Callout type={'info'}>
  mAI 当前默认使用 OpenAI `text-embedding-3-small` 模型，请确保你的 API Key 可以访问该模型。
</Callout>
...
通过正确配置和集成这些核心组件，您可以为 mAI 构建一个强大、高效的知识库系统。每个组件都在整体架构中扮演着关键角色，共同支持高级的文档管理和智能检索功能。
