---
title: 在 mAI 中配置 Apple 身份验证
description: 学习如何在 mAI 中配置 Apple 登录，包括在 Apple Developer Portal 创建凭证和设置环境变量。
tags:
  - Apple
  - 身份验证
  - mAI
...
<Callout type={'info'}>
  部署成功后，用户将可以通过 Apple 身份认证并使用 mAI。
</Callout>
