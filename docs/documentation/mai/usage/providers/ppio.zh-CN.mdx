---
title: 在 mAI 中使用 PPIO 派欧云 API Key
description: >-
  学习如何将 PPIO 派欧云的 LLM API 集成到 mAI 中。跟随以下步骤注册 PPIO 账号、创建 API Key、并在 mAI
  中进行设置。
tags:
  - PPIO
  - PPInfra
...
<Image alt={'在 mAI 中使用 PPIO'} cover src={'/blog/assets06d4e543cbaca9a2762923a23b2cae67.webp'} />

[PPIO 派欧云](https://ppinfra.com/user/register?invited_by=RQIMOC\&utm_source=github_mAI)提供稳定、高性价比的开源模型 API 服务，支持 DeepSeek 全系列、Llama、Qwen 等行业领先大模型。

本文档将指导你如何在 mAI 中使用 PPIO:

<Steps>
  ### 步骤一：注册 PPIO 派欧云账号并登录

  - 访问 [PPIO 派欧云](https://ppinfra.com/user/register?invited_by=RQIMOC\&utm_source=github_mAI) 并注册账号
  ...
  ### 步骤三：在 mAI 中配置 PPIO 派欧云

  - 访问 mAI 的 `设置` 界面
  - 在 `AI 服务商` 下找到 `PPIO` 的设置项
  - 打开 PPIO 并填入获得的 API 密钥

  <Image alt={'在 mAI 中输入 PPIO API 密钥'} inStep src={'/blog/assetsbfe7d519c29884b6699e89866e1db7e2.webp'} />
...
至此你已经可以在 mAI 中使用 PPIO 派欧云提供的模型进行对话了。
