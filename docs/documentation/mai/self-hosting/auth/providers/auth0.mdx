---
title: Configuring Auth0 Authentication for mAI
description: >-
  Learn how to configure Auth0 SSO for mAI, including creating applications,
...
<Callout type={'warning'}>
  When creating a GitHub connection, make sure to enable the **Email Address** permission in the **Attributes** section. mAI requires user email for authentication.
