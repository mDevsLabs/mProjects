---
title: Using Vercel AI Gateway in mAI
description: Learn how to integrate and use the unified API of Vercel AI Gateway in mAI
tags:
  - mAI
  - Vercel AI Gateway
  - API Key
...
# Using Vercel AI Gateway in mAI
...
This guide will walk you through how to use Vercel AI Gateway within mAI.
...
<Steps>
  ...
  ### Step 2: Configure Vercel AI Gateway in mAI
...
That's it! You can now start chatting in mAI using models provided by Vercel AI Gateway.
