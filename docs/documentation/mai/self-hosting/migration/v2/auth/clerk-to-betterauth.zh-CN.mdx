...
description: 将 mAI 部署从 Clerk 身份验证迁移到 Better Auth 的指南，包括简单迁移和完整迁移选项。
tags:
  - 身份验证服务
  - Better Auth
  - Clerk
...
本指南帮助您将现有的基于 Clerk 的 mAI 部署迁移到 Better Auth。
...
4. **通知用户**
   ...
   ![mAI 登录页面 - 社交账号登录提示](https://hub-apac-1.lobeobjects.space/docs/8d0563701fcd17ad7252a72b1746dd42.png)
