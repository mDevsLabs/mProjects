...
description: Learn how to configure and use the ModelScope provider in mAI
tags:
  - ModelScope
---
...
ModelScope is an open-source AI model community by Alibaba, offering access to a wide range of AI models. This guide will walk you through setting up the ModelScope provider in mAI.
