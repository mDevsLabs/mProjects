...
description: >-
  Guide for migrating your mAI deployment from Clerk authentication to
...
This guide helps you migrate your existing Clerk-based mAI deployment to Better Auth.
...
4. **Notify Users**
   ...
   ![mAI Login Page - Social Login Hint](https://hub-apac-1.lobeobjects.space/docs/8d0563701fcd17ad7252a72b1746dd42.png)
