...
description: >-
  Join the mAI Community as a creator — publish Agents, share workflows, and
...
The mAI Community brings together creators who design, share, and refine Agents for real-world use. Whether it's a productivity tool, a teaching assistant, or a creative collaborator, your work can reach thousands of users.

## Why Become a Creator

|               |                                                                          |
| ------------- | ------------------------------------------------------------------------ |
| **Reach**     | Your Agent is discoverable in the Agent Marketplace by all mAI users |
