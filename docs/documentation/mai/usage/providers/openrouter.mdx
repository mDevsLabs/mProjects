---
title: Using OpenRouter API Key in mAI
description: >-
  Learn how to register, create an API key, add credit, and configure OpenRouter
  in mAI to start using a variety of powerful large language model APIs.
tags:
  - OpenRouter
  - API Key
  - Web UI
...
# Using OpenRouter in mAI

<Image alt={'Using OpenRouter in mAI'} cover src={'/blog/assets34400653/40520a43-ac03-4954-8a4d-282fbb946066.webp'} />
...
This guide will walk you through how to use OpenRouter in mAI:
...
<Steps>
  ...
  - In the pop-up dialog, give your API key a name, such as "mAI Key".
  ...
  ### Step 4: Configure OpenRouter in mAI

  - Open the `Settings` panel in mAI.
  - Under `AI Providers`, find the `OpenRouter` section.
  - Enable OpenRouter and paste in your API key.

  <Image alt={'Configure OpenRouter in mAI'} height={518} inStep src={'/blog/assets34400653/5c3898ab-23d7-44c2-bbd9-b255e25e400c.webp'} />
...
You’re now ready to start using OpenRouter’s models in mAI for conversations.
