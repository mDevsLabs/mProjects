---
title: 在 mAI 中使用 Gitee AI
description: 学习如何在 mAI 中配置和使用 Gitee AI 的 API Key，以便开始对话和交互。
tags:
  - mAI
  - Gitee AI
  - API密钥
...
至此你已经可以在 mAI 中使用 Gitee AI 提供的模型进行对话了。
