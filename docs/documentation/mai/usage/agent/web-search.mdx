...
mAI's web search integration lets Agents access current information from the internet — real-time news, prices, documentation, and facts beyond their training cutoff. When web search is active, the Agent retrieves up-to-date answers and cites the sources it used.
...
<Callout type={'info'}>
  ...
  Managed mAI Cloud already has this wired for you.
</Callout>
