---
title: 在 mAI 中使用 01.AI 零一万物 API Key
description: 学习如何在 mAI 中配置并使用 01.AI 零一万物提供的 AI 模型进行对话。获取 API 密钥、填入设置项、选择模型，开始与 AI 助手交流。
tags:
  - mAI
  - 01.AI
  - Zero One AI
...
<Image alt={'在 mAI 中使用零一万物'} cover src={'/blog/assets34400653/4485fbc3-c309-4c4e-83ee-cb82392307a1.webp'} />

[零一万物](https://www.01.ai/)是一家致力于 AI 2.0 大模型技术和应用的全球公司，其发布的千亿参数的 Yi-Large 闭源模型，在斯坦福大学的英语排行 AlpacaEval 2.0 上，与 GPT-4 互有第一。

本文档将指导你如何在 mAI 中使用零一万物:
...
至此你已经可以在 mAI 中使用零一万物提供的模型进行对话了。
