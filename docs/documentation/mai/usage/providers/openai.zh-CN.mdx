---
title: 在 mAI 中使用 OpenAI API Key
description: 学习如何在 mAI 中配置和使用 OpenAI API Key，支持 GPT-4o / GPT-4-turbo / GPT-4.1
tags:
  - ChatGPT
  - GPT-4
  - GPT-4o
...
<Image alt={'在 mAI 中使用 OpenAI'} cover src={'/blog/assets17870709/c9e5eafc-ca22-496b-a88d-cc0ae53bf720.webp'} />

本文档将指导你如何在 mAI 中使用 [OpenAI](https://openai.com/):
...
至此你已经可以在 mAI 中使用 OpenAI 提供的模型进行对话了。
