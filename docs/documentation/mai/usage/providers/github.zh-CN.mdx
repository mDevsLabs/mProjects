---
title: 在 mAI 中使用 GitHub Models
description: 学习如何在 mAI 中配置和使用 GitHub 的 API Key，以便开始对话和交互。
tags:
  - mAI
  - GitHub
  - GitHub Models
...
本文将指导你如何在 mAI 中使用 GitHub Models。
...
至此你已经可以在 mAI 中使用 GitHub 提供的模型进行对话了。
