---
title: Build Your Own mAI - Choose Your Deployment Platform
description: >-
  Explore multiple deployment platforms like Vercel, Docker, Docker Compose, and
  more to deploy mAI. Choose the platform that best suits your needs.
tags:
  - mAI
  - Deployment Platform
  - Vercel
...
mAI can be self-hosted on your own infrastructure, giving you complete control over your data, customization, and deployment environment. Whether you're deploying for a team, organization, or personal use, mAI supports multiple deployment methods.

<PlatformCards urlPrefix={'platform'} />

## Architecture Overview

mAI consists of several key components:
...
Before deploying mAI, gather the following:
...
5. **Regular updates** — Keep mAI and dependencies up to date
