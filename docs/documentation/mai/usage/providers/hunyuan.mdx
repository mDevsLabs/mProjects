---
title: Using Tencent Hunyuan in mAI
description: >-
  Learn how to configure and use Tencent Hunyuan's API Key in mAI to start
...
This guide will walk you through how to use Tencent Hunyuan in mAI.
...
<Steps>
  ...
  ### Step 2: Configure Tencent Hunyuan in mAI
...
And that’s it! You’re now ready to use Tencent Hunyuan’s models for conversations in mAI.
