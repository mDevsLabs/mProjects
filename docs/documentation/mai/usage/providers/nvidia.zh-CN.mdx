---
title: 在 mAI 中使用 Nvidia NIM API Key
description: 学习如何在 mAI 中配置和使用 Nvidia NIM AI 模型，获取 API 密钥并开始对话。
tags:
  - mAI
  - Nvidia NIM
  - API密钥
...
# 在 mAI 中使用 Nvidia NIM

<Image alt={'在 mAI 中使用 Nvidia NIM'} cover src={'/blog/assetsd8927338578c426b833e5cb57e0b57ec.webp'} />
...
本文档将指导你如何在 mAI 中接入并使用 Nvidia NIM 提供的 AI 模型:
...
<Steps>
  ...
  ### 步骤二：在 mAI 中配置 Nvidia NIM

  - 访问 mAI 的 `应用设置` 的 `AI 服务供应商` 界面
...
至此你已经可以在 mAI 中使用 Nvidia NIM 提供的模型进行对话了。
