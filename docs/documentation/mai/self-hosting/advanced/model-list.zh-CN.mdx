---
title: mAI 自定义模型服务商模型列表及扩展能力配置
description: 了解如何在 mAI 中自定义模型列表以及扩展能力配置的基本语法和规则。
tags:
  - mAI
  - 自定义模型列表
  - 扩展能力配置
...
mAI 支持在部署时自定义模型列表，详情请参考 [模型提供商](/zh/docs/self-hosting/environment-variables/model-provider) 。
...
- 确认该模型在提供商 API 中实际支持该能力（mAI 无法开启 API 本身不提供的能力）
- 确认你运行的是足够新的 mAI 版本
