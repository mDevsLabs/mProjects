---
title: Using Nvidia NIM API Key in mAI
description: >-
  Learn how to configure and use Nvidia NIM AI models in mAI, obtain your
...
# Using Nvidia NIM in mAI

<Image alt={'Using Nvidia NIM in mAI'} cover src={'/blog/assetsd8927338578c426b833e5cb57e0b57ec.webp'} />
...
This guide will walk you through how to integrate and use AI models provided by Nvidia NIM in mAI:
...
<Steps>
  ...
  ### Step 2: Configure Nvidia NIM in mAI

  - Go to the `App Settings` section in mAI and navigate to `AI Service Providers`.
...
That’s it! You’re now ready to use Nvidia NIM-powered models in mAI for your conversations.
