---
title: Deploy mAI with database on Dokploy
description: >-
  Learn how to deploy mAI with database on Dokploy with ease, including:
...
This article will detail how to deploy the server database version of mAI.
...
Enter the created database and set an unused port in External Credentials to allow external access; otherwise, mAI will not be able to connect to the database. You can view the Postgres database connection URL in External Host, as shown below:
...
## Deploy mAI on Dokploy.

Click "Create Service", select "Application", and create the mAI application.

![Create mAI Application in Dokploy](/blog/assetsb33085e7553d2b7194005b102184553e.webp)

Enter the created mAI application, select the forked lobehub project and branch, and click Save to save.
...
![Deploy mAI and View Progress](/blog/assets7c3eab218c0823fa353b1cd23afe21c3.webp)

After a successful deployment, bind your own domain to your mAI application and request a certificate on the Domains page.

![Bind Domain and Request Certificate](/blog/assetseebf66254337ce88357629c34e78c08d.webp)

## Check if mAI is working properly.

Go to your mAI website, and if you click on the login button in the upper left corner and the login pop-up appears normally, it means you have configured it successfully. Enjoy it to the fullest!

![mAI Login Success](/blog/assets11a8089b511aaa61e8982dea0a3665c5.webp)
