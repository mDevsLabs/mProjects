...
From the mAI main interface, go to **Pages** and click **New Page**, or use the dropdown from the new file icon. Start writing immediately — your work auto-saves, so you can close anytime and pick up later.
