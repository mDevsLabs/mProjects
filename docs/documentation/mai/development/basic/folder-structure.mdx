...
description: >-
  Explore the organized directory structure of mAI, including app,
...
mAI uses a Monorepo architecture (`@lobechat/` namespace).
...
│                       # (SEO metadata, SPA HTML rendering, composio services, workflows-hono)
