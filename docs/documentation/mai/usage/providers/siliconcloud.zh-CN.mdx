---
title: 在 mAI 中使用 SiliconCloud
description: 学习如何在 mAI 中配置和使用 SiliconCloud 的API Key，以便开始对话和交互。
tags:
  - mAI
  - SiliconCloud
  - API密钥
...
本文将指导你如何在 mAI 中使用 SiliconCloud。
...
至此你已经可以在 mAI 中使用 SiliconCloud 提供的模型进行对话了。
