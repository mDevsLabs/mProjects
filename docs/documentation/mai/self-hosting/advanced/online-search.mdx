...
title: >-
  ...
  Information
description: >-
  Learn how to configure the SearXNG online search functionality for mAI,
...
When enabled, mAI replaces the Jina endpoints as follows:
...
You can find publicly available SearXNG instances in the [SearXNG instance list](https://searx.space/). Choose an instance that is fast and reliable, and then configure its URL in mAI.
...
- [mAI Online Search RFC Discussion](https://github.com/lobehub/lobehub/discussions/6447)
