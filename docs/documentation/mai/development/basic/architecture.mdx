...
description: >-
  Explore the architecture of mAI, an open-source AI Agent platform built on
...
mAI is an open-source AI Agent platform built on Next.js, enabling users to interact with AI through natural language, use tools, manage knowledge bases, and more. The following is an overview of mAI's architecture design.

## Application Architecture Overview

The overall architecture of mAI consists of the following core layers:
...
mAI uses [Better Auth](https://www.better-auth.com/) as the authentication framework, supporting:
