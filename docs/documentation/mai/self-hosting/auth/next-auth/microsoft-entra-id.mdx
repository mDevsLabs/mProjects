---
title: Configuration of Microsoft Entra ID Authentication Service for mAI
description: >-
  Learn how to configure Microsoft Entra ID Authentication Service for mAI,
...
<Steps>
  ...
  Go back to the "Microsoft Entra ID" interface, enter "Users", click on "New user", fill in the user information, and click on "Create" to create a user for using mAI.
