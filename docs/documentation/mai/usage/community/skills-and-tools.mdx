...
<AccordionGroup>
  <Accordion title="Built-in Skills">
    Pre-installed skills that ship with mAI:
    ...
    Built-in skills are maintained by the mAI team and automatically updated.
  </Accordion>

  <Accordion title="Market Skills">
    Community-created skills available from the mAI marketplace:
...
mAI includes several powerful built-in tools:
...
Extend agent capabilities with plugins from the mAI marketplace:
...
MCP is mAI's system for connecting agents to external tools and services — databases, APIs, file systems, development tools, and business applications.
