---
title: Using SiliconCloud in mAI
description: >-
  Learn how to configure and use SiliconCloud's API Key in mAI to start
...
This guide will walk you through how to use SiliconCloud within mAI.
...
<Steps>
  ...
  ### Step 2: Configure SiliconCloud in mAI
...
That's it! You're now ready to use SiliconCloud's models for conversations in mAI.
