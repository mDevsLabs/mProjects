---
title: Connect mAI to Discord
description: >-
  Learn how to create a Discord bot and connect it to your mAI agent as a
...
# Connect mAI to Discord

By connecting a Discord channel to your mAI agent, users can interact with the AI assistant directly through Discord server channels and direct messages.
...
<Steps>
  ...
  Visit the [Discord Developer Portal](https://discord.com/developers/applications) and click **New Application**. Give your application a name (e.g., "mAI Assistant") and click **Create**.
...
## Step 2: Configure Discord in mAI

<Steps>
  ### Open Channel Settings

  In mAI, navigate to your agent's settings, then select the **Channels** tab. Click **Discord** from the platform list.
  ...
  Click **Save Configuration**. Your credentials will be saved and mAI will start listening for Discord events.
</Steps>
...
Back in mAI's channel settings for Discord, click **Test Connection** to verify everything is configured correctly. Then send a message to your bot on Discord to confirm it responds.
...
To get it: in Discord, open **User Settings → Advanced** and turn on **Developer Mode**. Then right-click your own username anywhere in Discord and choose **Copy User ID**. Paste the numeric ID into **Your Platform User ID** in mAI's Advanced Settings.
...
To get it: with **Developer Mode** on, right-click the server name in your server list and choose **Copy Server ID**. Paste it into **Default Server** in mAI's Advanced Settings.

## Access Policies

mAI gates inbound traffic with three layered settings, all under **Advanced Settings** and all defaulting to permissive.
