---
title: Using the Anthropic Claude API Key in mAI
description: >-
  Learn how to configure and use the Anthropic Claude API in mAI, including
...
# Using Anthropic Claude in mAI

<Image alt={'Using Anthropic Claude in mAI'} cover src={'/blog/assets17870709/620b956b-dcb2-442a-8bb1-9aa22681dfa4.webp'} />

The Anthropic Claude API is now publicly available. This guide will walk you through how to use [Anthropic Claude](https://www.anthropic.com/api) in mAI:
...
<Steps>
  ...
  ### Step 2: Configure Anthropic Claude in mAI
...
That's it! You’re now ready to use Anthropic Claude models in mAI for conversations.
