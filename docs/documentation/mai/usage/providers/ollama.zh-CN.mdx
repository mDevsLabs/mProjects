---
title: 在 mAI 中使用 Ollama
description: 了解如何在 mAI 中使用 Ollama ，在你的本地运行大型语言模型，获得最前沿的 AI 使用体验。
tags:
  - Ollama
  - Web UI
  - API Key
...
<Image alt={'在 mAI 中使用 Ollama'} borderless cover src={'/blog/assets17870709/f579b39b-e771-402c-a1d1-620e57a10c75.webp'} />

Ollama 是一款强大的本地运行大型语言模型（LLM）的框架，支持多种语言模型，包括 Llama 3.1, Mistral 等。现在，mAI 已经支持与 Ollama 的集成，这意味着你可以在 mAI 中轻松使用 Ollama 提供的语言模型来增强你的应用。

本文档将指导你如何在 mAI 中使用 Ollama：

<Video alt={'在 mAI 中使用 Ollama的完整演示'} height={580} src="/blog/assets28616219/c32b56db-c6a1-4876-9bc3-acbd37ec0c0c.mp4" />
...
<Steps>
  ...
  接下来，你就可以使用 mAI 与本地 LLM 对话了。

  <Image alt="在 mAI 中与 llama3 对话" height="573" src="/blog/assets28616219/7f9a9a9f-fd91-4f59-aac9-3f26c6d49a1e.webp" />
</Steps>
...
在 mAI 中，我们默认开启了一些常用的大语言模型，例如 Llama 3.1、 Gemma 2 、 Mistral 等。当你选中模型进行对话时，我们会提示你需要下载该模型。

<Image alt="mAI 提示安装 Ollama 模型" height="460" src="/blog/assets28616219/4e81decc-776c-43b8-9a54-dfb43e9f601a.webp" />
...
<Callout type={'info'}>
  你可以前往 [与 Ollama 集成](/zh/docs/self-hosting/examples/ollama) 了解如何部署 mAI
  ，以满足与 Ollama 的集成需求。
</Callout>
