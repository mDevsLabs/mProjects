---
title: Using Vertex AI API Key in mAI
description: >-
  Learn how to configure and use Vertex AI models in mAI, obtain your API
...
# Using Vertex AI in mAI

<Image alt={'Using Vertex AI in mAI'} cover src={'/blog/assets95e6fe7c19ebfb9ead1c5a267aaf2a4e.webp'} />
...
This guide will walk you through how to integrate Vertex AI models into mAI:
...
<Steps>
  ...
  ### Step 3: Configure Vertex AI in mAI

  - Open mAI and go to the App Settings > AI Service Providers section.
...
You're all set! You can now start using Vertex AI models in mAI for your conversations.
