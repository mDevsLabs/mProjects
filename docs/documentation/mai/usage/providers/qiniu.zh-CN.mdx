---
title: 在 mAI 中使用七牛云大模型 API Key
description: 学习如何在 mAI 中配置和使用七牛云的大模型，提供强大的自然语言理解和生成能力。
tags:
  - API key
  - Web UI
  - 七牛
...
<Image alt={'在 mAI 中使用七牛云大模型'} cover src={'/blog/assets48b5c19e20fb870c7bdd34bd3aefbb21.webp'} />

[七牛云](https://www.qiniu.com)作为老牌云服务厂商，提供高性价比稳定的实时、批量 AI 推理服务，简单易用。

本文档将指导你如何在 mAI 中使用七牛云大模型:
...
至此你已经可以在 mAI 中使用七牛云提供的大模型进行对话了。
