---
title: Configure ZITADEL Authentication Service for mAI
description: >-
  Learn how to configure ZITADEL Authentication Service for mAI deployment,
...
<Steps>
  ...
  <Callout type={'important'}>
    ...
    - Replace `http(s)://your-domain` with the actual URL that mAI is deployed to.
  </Callout>
...
<Callout>
  After successful deployment, users will be able to authenticate and use mAI using existing
