---
title: 在 mAI 中使用 Moonshot（月之暗面） AI API Key
description: 学习如何在 mAI 中配置和使用 Moonshot AI，包括获取 API 密钥和选择适合的 AI 模型进行对话。
tags:
  - Moonshot AI
  - Web UI
  - API Key
...
# 在 mAI 中使用 Moonshot AI

<Image alt={'在 mAI 中使用 Moonshot AI'} cover src={'/blog/assets17870709/21b94782-875b-4dee-a572-3c5843f3e1e3.webp'} />

Moonshot AI API 现在可供所有人使用，本文档将指导你如何在 mAI 中使用 [Moonshot AI](https://www.moonshot.cn/):
...
至此你已经可以在 mAI 中使用 Moonshot AI 提供的模型进行对话了。
