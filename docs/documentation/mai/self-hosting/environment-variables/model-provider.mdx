---
title: mAI Model Service Providers - Environment Variables and Configuration
description: >-
...
When deploying mAI, a rich set of environment variables related to model service providers is provided, allowing you to easily define the model service providers to be enabled in mAI.
