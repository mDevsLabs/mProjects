---
title: Using Zhipu ChatGLM API Key in mAI
description: >-
  Learn how to configure and use Zhipu AI's API Key in mAI to start chatting
...
# Using Zhipu ChatGLM in mAI

<Image alt={'Using Zhipu AI in mAI'} cover src={'/blog/assets34400653/497e3b20-57ca-4963-b6f4-897c9710c16e.webp'} />
...
This guide will walk you through how to use Zhipu AI in mAI:
...
<Steps>
  ...
  ### Step 2: Configure Zhipu AI in mAI

  - Go to the `Settings` page in mAI
  - Under `AI Providers`, find the configuration section for `Zhipu AI`

  <Image alt={'Enter your Zhipu AI API Key in mAI'} inStep src={'/blog/assets34400653/2afffe79-1d37-423c-9363-f09605d5e640.webp'} />
...
And that’s it! You’re now ready to start chatting with models provided by Zhipu AI in mAI.
