...
description: >-
  Explore the client-server interaction logic of mAI Chat API, including
...
mAI Chat API in client-server interactions,
...
mAI supports three types of tools:
...
abstraction layer in mAI for interacting with
...
Agent Runtime (`packages/agent-runtime/`) is mAI's
