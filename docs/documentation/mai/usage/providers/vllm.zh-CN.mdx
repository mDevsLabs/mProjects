---
title: 在 mAI 中使用 vLLM API Key
description: 学习如何在 mAI 中配置和使用 vLLM 语言模型，获取 API 密钥并开始对话。
tags:
  - mAI
  - vLLM
  - API密钥
...
至此你已经可以在 mAI 中使用 vLLM 提供的模型进行对话了。
