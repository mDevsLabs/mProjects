---
title: Using Amazon Bedrock API Key in mAI
description: >-
  Learn how to configure and use Amazon Bedrock, a fully managed foundation
  model API service, in mAI to start chatting.
tags:
  - Amazon Bedrock
  - Claude 3.5 Sonnet
  - API keys
...
# Using Amazon Bedrock in mAI

<Image alt={'Using Amazon Bedrock in mAI'} cover src={'/blog/assets34400653/74768b36-28ca-4ec3-a42d-b32abe2c7057.webp'} />
...
This guide will walk you through how to use Amazon Bedrock in mAI:
...
<Steps>
  ...
  ### Step 3: Configure Amazon Bedrock in mAI

  - Open the `Settings` panel in mAI
  - Under `AI Providers`, find and enable the `Amazon Bedrock` option

  <Image alt={'Entering Amazon Bedrock keys in mAI'} inStep src={'/blog/assets34400653/7468594b-3355-4cb9-85bc-c9dace137653.webp'} />
...
You’re all set! You can now start chatting in mAI using models provided by Amazon Bedrock.
