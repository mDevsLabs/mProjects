---
title: Using the Google Gemma Model in mAI
description: >-
  Easily perform natural language processing tasks with the Google Gemma model
  through mAI's integration with Ollama. Install Ollama, pull the Gemma
...
<Image alt={'Using Gemma in mAI'} cover rounded src={'/blog/assets17870709/65d2dd2a-fdcf-4f3f-a6af-4ed5164a510d.webp'} />

[Gemma](https://blog.google/technology/developers/gemma-open-models/) is an open-source large language model (LLM) developed by Google. It is designed to be a general-purpose and flexible model for a wide range of natural language processing (NLP) tasks. Now, thanks to mAI’s integration with [Ollama](https://ollama.com/), you can easily use Google Gemma directly within mAI.

This guide will walk you through how to use the Google Gemma model in mAI:
...
<Steps>
  ...
  <Callout type={'info'}>
    If you don’t see the Ollama provider in the model selection panel, refer to the [Ollama Integration Guide](/en/docs/self-hosting/examples/ollama) to learn how to enable the Ollama provider in mAI.
  </Callout>
</Steps>

You’re all set! You can now start chatting with the local Gemma model directly in mAI.
