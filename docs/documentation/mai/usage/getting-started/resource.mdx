...
- **Notion import** — Import content from Notion into mAI for seamless knowledge management across platforms.

**Access the Resource Library** — Click the **Resources** icon at the bottom of the left sidebar on the mAI main interface.
...
Export documents from Notion, then import the Notion ZIP file via the **Connect Notion** page. Once imported, you can continue editing these documents within mAI.
