---
title: 在 mAI 中使用本地通义千问 Qwen 模型
description: 通过 mAI 与 Ollama 的集成，轻松在本地部署的通义千问 Qwen 模型中进行对话。学习如何安装和选择 Qwen 模型。
tags:
  - 通义千问
  - Qwen模型
  - mAI集成
...
<Image alt={'在 mAI 中使用 Qwen'} cover src={'/blog/assets17870709/b4a01219-e7b1-48a0-888c-f0271b18e3a6.webp'} />
...
现在，通过 mAI 与 [Ollama](https://ollama.com/) 的集成，你可以轻松地在 mAI 中使用 通义千问。

本文档将指导你如何在 mAI 中使用通义千问本地部署版：
