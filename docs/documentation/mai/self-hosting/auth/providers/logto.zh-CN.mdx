---
title: 在 mAI 中配置 Logto 身份验证
description: 学习如何在 mAI 中配置 Logto SSO，包括创建应用和设置环境变量。
tags:
  - Logto
  - 身份验证
  - mAI
...
<Steps>
  ...
  配置 Logto 的 [Webhook](https://docs.logto.io/developers/webhooks/configure-webhooks)，以便在用户信息更新时 mAI 可以接收到通知并同步数据。
