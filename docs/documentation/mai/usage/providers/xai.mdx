---
title: Using xAI in mAI
description: >-
  Learn how to configure and use xAI's API Key in mAI to start chatting and
  interacting.
tags:
  - mAI
  - xAI
...
This guide will walk you through how to use xAI within mAI.
...
You’re now ready to start using xAI-powered models in mAI for conversations and interactions.
