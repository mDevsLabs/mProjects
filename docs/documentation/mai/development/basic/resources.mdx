...
description: >-
  Explore key resources and references for mAI's design and development
  process.
tags:
  - mAI
  - OpenAI API
...
5. **Chat-Next-Web**: Chat Next Web is an excellent project, and some of mAI's features and workflows are referenced from its implementation. You can view the source code and documentation on the [Chat-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web) GitHub repository.
...
7. **FlowGPT**: FlowGPT is currently the world's largest Prompt community, and some of the agents in mAI come from active authors in FlowGPT. You can visit [FlowGPT](https://flowgpt.com/) to learn more about it.

## mAI Official Ecosystem

- [🍭 LobeUI](https://github.com/lobehub/lobe-ui) (`@lobehub/ui`): mAI UI component library
