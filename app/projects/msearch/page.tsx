        ...
        >
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-blue-600 dark:text-blue-400 font-medium text-lg italic mt-1">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="text-slate-600 dark:text-slate-300 text-lg leading-relaxed mb-8">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-1 text-blue-600 dark:text-blue-400 font-semibold ml-1 group relative transition-colors"
            >
              ...
              <span className="absolute inset-x-0 -bottom-0.5 h-0.5 bg-blue-600 dark:bg-blue-400 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></span>
            </a>
