---
title: mAI Knowledge Base / File Upload
description: >-
  Explore mAI's file upload and knowledge base management features with core
  components.
tags:
  - mAI
  - File Upload
...
mAI supports file upload and knowledge base management. This feature relies on the following core technical components. Understanding these components will help you successfully deploy and maintain the knowledge base system.
...
<Callout type={'info'}>
  mAI currently uses OpenAI's `text-embedding-3-small` model by default. Ensure your API Key
...
By correctly configuring and integrating these core components, you can build a powerful and efficient knowledge base system for mAI. Each component plays a crucial role in the overall architecture, supporting advanced document management and intelligent retrieval functions.
