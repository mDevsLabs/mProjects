---
title: Using Tongyi Qianwen API Key in mAI
description: >-
  Learn how to configure and use Alibaba Cloud's Tongyi Qianwen model in
  mAI, offering powerful natural language understanding and generation
  capabilities.
tags:
  - mAI
  - Tongyi Qianwen
...
# Using Tongyi Qianwen in mAI

<Image alt={'Using Tongyi Qianwen in mAI'} cover src={'/blog/assets34400653/4e057b43-1e3e-4e96-a948-7cdbff303dcb.webp'} />
...
This guide will walk you through how to use Tongyi Qianwen in mAI:
...
<Steps>
  ...
  ### Step 3: Configure Tongyi Qianwen in mAI
...
You’re all set! You can now start using Tongyi Qianwen’s models in mAI for intelligent conversations.
