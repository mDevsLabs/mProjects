---
title: Using Azure OpenAI API Key in mAI
description: >-
  Learn how to configure and use Azure OpenAI models in mAI, including how
...
# Using Azure OpenAI in mAI

<Image alt={'Using Azure OpenAI in mAI'} cover src={'/blog/assets17870709/5efa34c2-6523-43e6-9ade-70ab5d802e13.webp'} />

This guide will walk you through how to use [Azure OpenAI](https://oai.azure.com/) in mAI:
...
<Steps>
  ...
  ### Step 2: Configure Azure OpenAI in mAI
...
And that’s it! You’re now ready to start chatting with models powered by Azure OpenAI in mAI.
