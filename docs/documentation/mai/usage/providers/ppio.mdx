---
title: Using PPIO API Key in mAI
description: >-
  Learn how to integrate PPIO's LLM API into mAI. Follow these steps to
  register a PPIO account, create an API key, and configure it in mAI.
tags:
  - PPIO
  - PPInfra
  - DeepSeek
...
<Image alt={'Using PPIO in mAI'} cover src={'/blog/assets06d4e543cbaca9a2762923a23b2cae67.webp'} />

[PPIO](https://ppinfra.com/user/register?invited_by=RQIMOC\&utm_source=github_mAI) offers stable and cost-effective API services for open-source large language models, supporting industry-leading models such as DeepSeek, Llama, and Qwen.

This guide will walk you through how to use PPIO in mAI:

<Steps>
  ### Step 1: Register and Log In to PPIO

  - Visit [PPIO](https://ppinfra.com/user/register?invited_by=RQIMOC\&utm_source=github_mAI) and sign up for an account.
  ...
  ### Step 3: Configure PPIO in mAI

  - Open the Settings panel in mAI.
  - Under the "AI Providers" section, find and select "PPIO".
  - Enable PPIO and paste in your API key.

  <Image alt={'Enter PPIO API Key in mAI'} inStep src={'/blog/assetsbfe7d519c29884b6699e89866e1db7e2.webp'} />
...
That's it! You're now ready to use PPIO's models for conversations in mAI.
