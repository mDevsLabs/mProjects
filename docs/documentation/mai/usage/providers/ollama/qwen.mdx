---
title: Using the Local Qwen Model in mAI
description: >-
  Easily chat with the locally deployed Qwen model through mAI's integration
...
<Image alt={'Using Qwen in mAI'} cover src={'/blog/assets17870709/b4a01219-e7b1-48a0-888c-f0271b18e3a6.webp'} />
...
Now, thanks to mAI’s integration with [Ollama](https://ollama.com/), you can easily use the Qwen model locally within mAI.

This guide will walk you through how to use the locally deployed Qwen model in mAI:
...
You’re now ready to start chatting with the local Qwen model in mAI.
