...
description: >-
  ...
  — can see and do in mAI, covering workspace management, billing, AI
...
Every member of a mAI workspace has one of three roles. This page is the complete reference of what each role can see and do.
