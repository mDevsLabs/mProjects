---
title: 架构设计
description: 深入了解 mAI 的架构设计，包括前端、后端、运行时和数据存储。
tags:
  - mAI
  - 架构设计
  - Agent 平台
...
mAI 是一个基于 Next.js 构建的开源 AI Agent 平台，使用户能够与 AI 进行自然语言交互、使用工具、管理知识库等。以下是 mAI 的架构设计概览。
...
mAI 使用 [Better Auth](https://www.better-auth.com/) 作为认证框架，支持：
