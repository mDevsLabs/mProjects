---
title: Using Google Gemini API Key in mAI
description: >-
  This guide will walk you through how to configure and use Google Gemini, a
  powerful language model developed by Google AI, within mAI.
tags:
  - Google Gemini
  - Google AI
  - API Key
...
# Using Google Gemini in mAI

<Image alt={'Using Google Gemini in mAI'} cover src={'/blog/assets34400653/9a8dc1d4-152b-415f-a7cd-8f0c8fbb9913.webp'} />
...
This guide will show you how to use Google Gemini in mAI:
...
<Steps>
  ...
  ### Step 2: Configure Google Gemini in mAI

  - Go to the Settings page in mAI
  - Under "AI Providers", locate the "Google Gemini" section

  <Image alt={'Enter Google Gemini API Key in mAI'} inStep src={'/blog/assets34400653/11442ce4-a615-49c4-937a-ca2ae93dd27c.webp'} />
...
And that’s it — you’re now ready to use Google Gemini in mAI!
