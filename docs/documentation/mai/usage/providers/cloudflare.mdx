---
title: Using Cloudflare Workers AI in mAI
description: >-
  Learn how to configure and use the Cloudflare Workers AI API Key in mAI to
...
# Using Cloudflare Workers AI in mAI
...
This guide will walk you through how to use Cloudflare Workers AI in mAI:
...
<Steps>
  ...
  ### Step 2: Configure Cloudflare Workers AI in mAI
...
You’re all set! You can now start using Cloudflare Workers AI models for conversations in mAI.
