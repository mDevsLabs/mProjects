---
title: mAI 特性标志环境变量配置指南
description: 了解如何使用环境变量自定义 mAI 的特性标志，包括控制否启用某个功能、或者根据需要对特定用户群体或环境启用或禁用功能。
tags:
  - mAI
  - 环境变量
  - 配置指南
...
除了基础的环境变量配置外，mAI 还提供了一些特性标志（Feature Flags），用于控制是否全局启用某个功能，或者根据需要对特定用户群体或环境启用或禁用功能。
