---
title: Using GitHub Models in mAI
description: >-
  Learn how to configure and use GitHub's API Key in mAI to start
...
This guide will walk you through how to use GitHub Models within mAI.
...
<Steps>
  ...
  ### Step 2: Configure GitHub Models in mAI
...
And that’s it! You’re now ready to start using GitHub-provided models in mAI for conversations and interactions.
