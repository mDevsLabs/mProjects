...
title: Task Tools
description: >-
  Manage tasks through conversation with the built-in Task tool — capture
  work, track progress, assign subtasks, and automate follow-through.
tags:
  - mAI
  - Task
  - Task Management
...
If you use the mAI CLI, the same task system is available from the command line via `lh task`:
