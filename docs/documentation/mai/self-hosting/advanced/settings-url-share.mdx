...
description: >-
  Learn how to import and export configuration settings for mAI via URL.
...
mAI support import settings from external URL to quickly set up mAI configuration.
...
<Callout type={'warning'}>
  mAI does not verify the correctness of the settings parameters in the URL, nor provide
