---
title: Configuring Github Authentication Service for mAI
description: >-
  Learn how to configure Github authentication service for mAI, including
...
<Steps>
  ...
  | `NEXT_AUTH_SSO_PROVIDERS` | Required | Select the Single Sign-On provider for mAI. Use `github` for Github.                                                                                                                              |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Github and use mAI.
</Callout>
