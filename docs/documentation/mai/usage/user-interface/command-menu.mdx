...
title: Command Menu
description: >-
  The quick action center of mAI — search Agents, Topics, settings, and jump
...
The Command Menu is mAI's quick action center. Press `⌘ + K` (Mac) or `Ctrl + K` (Windows/Linux) and a search overlay appears. Type a few keywords to find Agents, Topics, settings, or actions — no need to click through menus or the sidebar. It's the fastest way to navigate mAI.
