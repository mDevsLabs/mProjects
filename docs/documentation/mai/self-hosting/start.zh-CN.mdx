---
title: 构建属于自己的 mAI - 自选部署平台
description: >-
  选择适合自己的部署平台，构建个性化的 mAI。支持 Docker、Docker
...
mAI 支持私有化部署，让你完全掌控自己的数据、自定义选项和部署环境。无论是为团队、组织还是个人使用，mAI 都提供多种部署方式。
