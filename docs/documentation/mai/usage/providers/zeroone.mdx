---
title: Using the 01.AI API Key in mAI
description: >-
  Learn how to configure and use AI models provided by 01.AI (Zero One AI) in
  mAI. Get your API key, enter it in the settings, choose a model, and start
...
# Using Zero One AI in mAI

<Image alt={'Using Zero One AI in mAI'} cover src={'/blog/assets34400653/4485fbc3-c309-4c4e-83ee-cb82392307a1.webp'} />
...
This guide will walk you through how to use 01.AI in mAI:
...
And that’s it! You’re now ready to use 01.AI’s models in mAI for intelligent conversations.
