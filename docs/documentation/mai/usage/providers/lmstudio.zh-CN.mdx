---
title: 在 mAI 中使用 LM Studio
description: 学习如何配置和使用 LM Studio，并在 mAI 中 通过 LM Studio 运行 AI 模型进行对话。
tags:
  - mAI
  - LM Studio
  - 开源模型
...
<Image alt={'在 mAI 中使用 LM Studio'} cover src={'/blog/assets28749075f0c4d62c1642694a4ed9ec08.webp'} />
...
至此你已经可以在 mAI 中使用 LM Studio 运行的模型进行对话了。
