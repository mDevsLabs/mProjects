---
title: Configuring Cloudflare Zero Trust Authentication for mAI
description: >-
  Learn how to configure Cloudflare Zero Trust SSO for mAI, including
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`                | Required | SSO provider for mAI. Use `cloudflare-zero-trust`                         |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Cloudflare Zero Trust and use mAI.
</Callout>
