...
description: >-
  Step-by-step guide to configure Upstash Redis for mAI cache and session
  storage.
tags:
  - Upstash
  - Redis
...
[Upstash](https://upstash.com/) is a serverless Redis service that provides a free tier and pay-as-you-go pricing, making it ideal for mAI deployments.
...
<Steps>
  ...
  <Callout type={'info'}>
    Upstash uses `rediss://` (with double 's') for TLS connections. mAI supports this format automatically.
  </Callout>
</Steps>
