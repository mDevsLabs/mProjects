---
title: Using Wenxin Qianfan in mAI
description: >-
  Learn how to configure and use the Wenxin Qianfan API Key in mAI to start
...
This guide will walk you through how to use Wenxin Qianfan in mAI.
...
<Steps>
  ...
  ### Step 2: Configure Wenxin Qianfan in mAI
...
Now you're all set to start using Wenxin Qianfan models for conversations in mAI.
