---
title: Using Jina AI API Key in mAI
description: >-
  Learn how to configure and use Jina AI models in mAI, obtain your API key,
  and start chatting.
tags:
  - mAI
  - Jina AI
...
# Using Jina AI in mAI

<Image alt={'Using Jina AI in mAI'} cover src={'/blog/assetsc6ff27b7134f280727e1fd7ff83ed2fa.webp'} />
...
This guide will walk you through how to use Jina AI in mAI:
...
<Steps>
  ...
  ### Step 2: Configure Jina AI in mAI
...
And that’s it! You’re now ready to start chatting with models powered by Jina AI in mAI.
