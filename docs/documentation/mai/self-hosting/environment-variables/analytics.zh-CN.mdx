---
title: 在 mAI 中 配置数据统计服务环境变量指南
description: 了解如何在 mAI 中配置各种数据统计服务的环境变量，包括Vercel Analytics、Google Analytics 等。
tags:
  - 数据统计
  - 环境变量
  - Vercel Analytics
...
我们在 mAI 中集成了若干免费 / 开源的数据统计服务，用于了解用户的使用情况，以下是相关环境变量。
