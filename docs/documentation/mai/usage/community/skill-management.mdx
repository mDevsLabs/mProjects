...
| ------------------------ | ------------------------------------ | ----------------------------------------- |
| **Built-in tools**       | Capabilities built into mAI      | Artifacts, Sandbox, GTD, Notebook, Memory |
| **mAI Integrations** | OAuth-connected third-party services | Linear, Microsoft, Twitter                |
...
- **mAI** — Built-in tools and mAI-native integrations (Linear, Microsoft, Twitter, Composio services)
...
Built-in tools (Artifacts, Sandbox, GTD, Notebook) are pre-installed — you can enable them for any Agent immediately. mAI Integrations and Composio services require an OAuth connection:

1. In the Skill Store, go to the **mAI** tab
...
**Integrations** — Built-in tools, mAI-connected services, and Composio integrations. Each shows its connection status. Click **Connect** or **Disconnect** to manage the OAuth link.
