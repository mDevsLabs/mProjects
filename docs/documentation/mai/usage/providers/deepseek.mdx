---
title: Using DeepSeek API Key in mAI
description: >-
  Learn how to configure and use the DeepSeek language model in mAI, obtain
...
# Using DeepSeek in mAI

<Image alt={'Using DeepSeek in mAI'} cover src={'/blog/assets34400653/b4d12904-9d5d-46de-bd66-901eeb9c8e52.webp'} />
...
This guide will walk you through how to use DeepSeek in mAI:
...
<Steps>
  ...
  ### Step 2: Configure DeepSeek in mAI

  - Go to the `App Settings` page in mAI
  - Under `AI Providers`, find the `DeepSeek` configuration section

  <Image alt={'Enter DeepSeek API Key in mAI'} inStep src={'/blog/assets93da89c4892a80e2e5a6caa49d80af5f.webp'} />
...
And that’s it! You’re now ready to start chatting with DeepSeek-powered models in mAI.
