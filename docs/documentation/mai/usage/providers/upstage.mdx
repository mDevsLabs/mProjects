---
title: Using Upstage in mAI
description: >-
  Learn how to configure and use Upstage's API Key in mAI to start
...
This guide will walk you through how to use Upstage within mAI.
...
<Steps>
  ...
  ### Step 2: Configure Upstage in mAI
...
And that’s it! You’re now ready to use Upstage’s models for conversations in mAI.
