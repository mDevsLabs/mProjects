---
title: Configuring ZITADEL Authentication for mAI
description: >-
  Learn how to configure ZITADEL SSO for mAI, including creating an
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`  | Required | SSO provider for mAI. Use `zitadel` for ZITADEL                           |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with ZITADEL and use mAI.
</Callout>
