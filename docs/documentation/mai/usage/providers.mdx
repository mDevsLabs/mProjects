---
title: Using Multiple Model Providers in mAI
description: >-
  Learn about the latest developments in mAI's support for multiple model
...
# Using Multiple Model Providers in mAI
...
mAI integrates with 70+ AI model providers:
