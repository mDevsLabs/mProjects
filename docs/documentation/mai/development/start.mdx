...
description: >-
  Explore the mAI development setup, technology stack, and contribution
  guidelines.
tags:
  - mAI
  - Next.js
...
Welcome to the mAI Technical Development Getting Started Guide. mAI is an AI conversation application built on the Next.js framework, incorporating a range of technology stacks to achieve diverse functionalities and features. This guide will detail the main technical components of mAI and how to configure and use these technologies in your development environment.

## Basic Technology Stack

The core technology stack of mAI is as follows:
...
mAI uses a Monorepo architecture
(`@lobechat/` namespace).
...
mAI uses `react-i18next` for multilingual support,
...
To support developers in better understanding and using the technology stack of mAI, we provide a comprehensive list of resources and references — [mAI Resources and References](/docs/development/basic/resources) - Visit our maintained list of resources, including tutorials, articles, and other useful links.

We encourage developers to utilize these resources to deepen their learning and enhance their skills, join community discussions through [mAI GitHub Discussions](https://github.com/lobehub/lobehub/discussions) or [Discord](https://discord.com/invite/AYFPHvv2jT), ask questions, or share your experiences.
