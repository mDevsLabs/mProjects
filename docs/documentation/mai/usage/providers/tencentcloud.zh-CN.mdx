---
title: 在 mAI 中使用腾讯云 API Key
description: 学习如何在 mAI 中配置和使用腾讯云 AI 模型，获取 API 密钥并开始对话。
tags:
  - mAI
  - 腾讯云
  - API密钥
