---
title: 在 mAI 中使用 302.AI
description: 学习如何在 mAI 中配置和使用 302.AI 的API Key，以便开始对话和交互。
tags:
  - mAI
  - 302.AI
  - API密钥
...
至此你已经可以在 mAI 中使用 302.AI 提供的模型进行对话了。
