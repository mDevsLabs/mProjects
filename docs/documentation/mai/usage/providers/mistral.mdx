---
title: Using Mistral AI API Key in mAI
description: >-
  Learn how to configure and use Mistral AI in mAI, including how to obtain
...
# Using Mistral AI in mAI

<Image alt={'Using Mistral AI in mAI'} cover src={'/blog/assets17870709/a3f9f63a-48f8-4567-b960-7f3636c0d4ed.webp'} />

The Mistral AI API is now publicly available. This guide will walk you through how to use [Mistral AI](https://mistral.ai/) in mAI:
...
<Steps>
  ...
  ### Step 2: Configure Mistral AI in mAI
...
You're all set! You can now start chatting with models powered by Mistral AI in mAI.
