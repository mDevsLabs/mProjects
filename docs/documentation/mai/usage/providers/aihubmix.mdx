...
description: Learn how to configure and use the AiHubMix provider in mAI
tags:
  - AiHubMix
...
AiHubMix is an AI model aggregation platform that offers access to a variety of AI models through a unified OpenAI-compatible API. This guide will help you set up the AiHubMix provider in mAI.
...
2. **Obtain an API Key**
   ...
   - Generate an API key for use with mAI
