---
title: Using Azure AI API Key in mAI
description: >-
  Learn how to configure and use Azure AI models in mAI, obtain your API
...
# Using Azure AI in mAI

<Image alt={'Using Azure AI in mAI'} cover src={'/blog/assets29de82efbe7657a8b9ba7daf0904585d.webp'} />
...
This guide will walk you through how to integrate Azure AI models into mAI:
...
<Steps>
  ...
  ### Step 3: Configure Azure AI in mAI
...
That's it! You're now ready to use Azure AI models for conversations in mAI.
