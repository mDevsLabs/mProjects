---
title: Configuring Email/Password Authentication for mAI
description: >-
  Learn how to configure email and password authentication for mAI,
...
mAI supports traditional email and password authentication out of the box.
