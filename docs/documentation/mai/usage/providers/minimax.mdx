---
title: Using the Minimax API Key in mAI
description: >-
  Learn how to configure and use the MiniMax AI model in mAI. This guide
...
# Using Minimax in mAI

<Image alt={'Using Minimax in mAI'} cover src={'/blog/assets34400653/703f170b-c03b-4c71-b57d-c2357596bdfb.webp'} />
...
This guide will walk you through how to use MiniMax in mAI:
...
<Steps>
  ...
  ### Step 2: Configure MiniMax in mAI
...
You're all set! You can now start chatting with models powered by MiniMax in mAI.
