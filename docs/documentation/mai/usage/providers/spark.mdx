---
title: Using iFLYTEK Spark in mAI
description: >-
  Learn how to configure and use the iFLYTEK Spark API Key in mAI to start
...
This guide will walk you through how to use iFLYTEK Spark in mAI.
...
<Steps>
  ...
  ### Step 2: Configure iFLYTEK Spark in mAI
...
That's it! You're now ready to use iFLYTEK Spark's models for conversations in mAI.
