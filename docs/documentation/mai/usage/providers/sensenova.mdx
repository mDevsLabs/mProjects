---
title: Using SenseTime SenseNova in mAI
description: >-
  Learn how to configure and use your SenseTime SenseNova API Key in mAI to
...
# Using SenseTime SenseNova in mAI
...
This guide will walk you through how to use SenseNova within mAI.
...
<Steps>
  ...
  ### Step 2: Configure SenseNova in mAI
...
And that’s it! You’re now ready to use SenseTime SenseNova models in mAI for intelligent conversations.
