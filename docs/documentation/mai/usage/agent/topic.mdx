...
In mAI, each conversation with an Agent is organized as a Topic. Topics give you a structured way to manage your conversation history — search across them, rename for clarity, favorite what you return to often, and clean up what you no longer need.
...
- **By status** — Groups Topics by their run state (e.g. running, waiting for human, completed, failed, paused, archived) so you can quickly spot what needs attention.
