...
description: 学习如何为 mAI ComfyUI 集成添加新模型、工作流和功能扩展
tags:
  - ComfyUI
  - 开发指南
  - 模型扩展
...
本指南基于实际代码实现，帮助开发者扩展 mAI 的 ComfyUI 集成功能。

## 架构概览

mAI ComfyUI 集成采用四层服务架构，围绕 `LobeComfyUI` 主类构建：
...
通过遵循这些指南，开发者可以有效地在 mAI 中使用和扩展 ComfyUI 功能，为用户提供强大的图像生成和处理能力。
