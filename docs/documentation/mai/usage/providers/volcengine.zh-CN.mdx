---
title: 在 mAI 中使用火山引擎 API Key
description: 学习如何在 mAI 中配置和使用火山引擎 AI 模型，获取 API 密钥并开始对话。
tags:
  - mAI
  - 火山引擎
  - 豆包
...
<Image alt={'在 mAI 中使用火山引擎'} cover src={'/blog/assets80a8b9627374fc345f4bf8e3adf11074.webp'} />

[火山引擎](https://www.volcengine.com/)是字节跳动旗下的云服务平台，通过 "火山方舟" 提供大型语言模型 (LLM) 服务，支持多个主流模型如豆包（Doubao）、DeepSeek、GLM 等。

本文档将指导你如何在 mAI 中使用火山引擎:
...
至此你已经可以在 mAI 中使用火山引擎提供的模型进行对话了。
