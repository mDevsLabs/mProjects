...
mAI 的 MCP 市场汇聚了来自全球创作者的优质 MCP，提供超过 10,000 个现成工具，随时为你的助理注入能力。
...
<Callout type={'info'}>请谨慎使用来路不明的 MCP，mAI 无法确保所有 MCP 的安全性。</Callout>

### 一键安装（桌面端）

mAI 桌面应用提供最便捷的 MCP 插件安装方式：
...
你可以将任何 MCP 兼容的服务器直接添加到 mAI，无需经过市场。详细操作步骤请参见[自定义 MCP](/zh/docs/usage/community/custom-mcp) 指南，或查看[技能管理](/zh/docs/usage/community/skill-management) 指南了解所有技能类型及管理方式。
