---
title: Configuring Generic OIDC Authentication for mAI
description: >-
  Learn how to configure any OpenID Connect provider for mAI using Generic
  OIDC integration.
tags:
  - Generic OIDC
  - OpenID Connect
...
Use Generic OIDC to integrate mAI with any OpenID Connect compliant identity provider not explicitly listed in our supported providers.
