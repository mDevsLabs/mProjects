---
title: 新身份验证方式开发指南
description: 学习如何在 mAI 中使用 Better Auth 添加新的身份验证提供者。
tags:
  - 身份验证
  - Better Auth
  - OAuth
...
mAI 使用 [Better Auth](https://www.better-auth.com) 作为外部身份验证服务。Better Auth 是一个开源的身份验证库，它提供了一种简单的方式来实现身份验证和授权功能。本文档将介绍如何添加新的 SSO 身份验证提供商。

为了在 mAI 中添加新的身份验证提供者（例如添加 GitLab)，你需要完成以下步骤：
