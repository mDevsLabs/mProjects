---
title: 在 mAI 中配置 Cloudflare Zero Trust 身份验证
description: 学习如何在 mAI 中配置 Cloudflare Zero Trust SSO，包括创建 Access 应用。
tags:
...
<Callout type={'info'}>部署成功后，用户将可以通过 Cloudflare Zero Trust 身份认证并使用 mAI。</Callout>
