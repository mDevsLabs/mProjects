...
description: >-
  Configure mAI email service for email verification, password reset, and
  magic link login.
tags:
  - Email Service
  - SMTP
...
Email service is used for email verification, password reset, and magic link delivery. mAI supports two email service providers.
