...
description: >-
  Track your mAI usage — days active, Agents, conversations, model usage.
...
Data Analytics gives you a clear picture of how you use mAI. View usage days, Agent count, conversation volume, and model distribution — plus an activity heatmap for the past year. Understand your patterns, spot trends, and optionally share your stats with others.
...
| Metric                 | Description                                      |
| ---------------------- | ------------------------------------------------ |
| **Days of Use**        | Total days since you first started using mAI |
...
- **Use the heatmap for reflection** — If you want to use mAI more consistently, the heatmap can help you set and track habits.
