---
title: 技术开发上手指南
description: 了解 mAI 的技术栈和开发环境设置，快速上手开发。
tags:
  - mAI
  - 技术开发
  - Next.js
...
欢迎来到 mAI 技术开发上手指南。mAI 是一款基于 Next.js 框架构建的 AI 会话应用，它汇集了一系列的技术栈，以实现多样化的功能和特性。本指南将详细介绍 mAI 的主要技术组成，以及如何在你的开发环境中配置和使用这些技术。
...
mAI 采用 Monorepo 架构（`@lobechat/` 命名空间），顶层目录结构如下：
...
在 mAI 项目中，我们十分重视代码的质量和一致性。为此，我们制定了一系列的代码风格规范和贡献流程，以确保每位开发者都能顺利地参与到项目中。以下是你作为开发者需要遵守的代码风格和贡献准则。
...
mAI 采用 `react-i18next` 实现多语言支持，确保用户全球化体验。
...
为了支持开发者更好地理解和使用 mAI 的技术栈，我们提供了一份详尽的资源与参考列表 —— [mAI 资源与参考](/zh/docs/development/basic/resources) - 访问我们维护的资源列表，包括教程、文章和其他有用的链接。

我们鼓励开发者利用这些资源深入学习和提升技能，通过 [mAI GitHub Discussions](https://github.com/lobehub/lobehub/discussions) 或者 [Discord](https://discord.com/invite/AYFPHvv2jT) 加入社区讨论，提出问题或分享你的经验。
