...
Click the **Share** button in the top-right corner of the chat window to export and share your current conversation. mAI supports multiple formats — choose the one that fits how you want to use it.
...
- **Default** — mAI's standard JSON format
