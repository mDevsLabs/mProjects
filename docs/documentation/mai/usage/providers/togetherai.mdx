---
title: Using the Together AI API Key in mAI
description: >-
  Learn how to configure and use the Together AI API key in mAI to start
...
# Using Together AI in mAI

<Image alt={'Using Together AI in mAI'} cover src={'/blog/assets34400653/28e025dd-367b-4add-85b6-499f4aacda61.webp'} />
...
This guide will walk you through how to use Together AI in mAI:
...
<Steps>
  ...
  ### Step 2: Configure Together AI in mAI

  - Go to the Settings page in mAI
  - Under the AI Providers section, find the settings for together.ai

  <Image alt={'Enter your Together AI API key in mAI'} inStep src={'/blog/assets34400653/0cc6c9b8-4688-472b-a80f-f84c5ebbc719.webp'} />
...
And that’s it! You’re now ready to use Together AI models for conversations in mAI.
