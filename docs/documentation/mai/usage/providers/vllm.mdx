---
title: Using vLLM API Key in mAI
description: >-
  Learn how to configure and use vLLM language models in mAI, obtain an API
...
<Image alt={'Using vLLM in mAI'} cover src={'/blog/assets1049abec5850cebf8ce12cd50199b9c5.webp'} />
...
This guide will walk you through how to use vLLM in mAI:
...
<Steps>
  ...
  ### Step 4: Configure vLLM in mAI

  - Open the `App Settings` panel in mAI
...
You're now ready to use vLLM-powered models in mAI for conversations.
