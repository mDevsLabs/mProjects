...
title: Getting mAI
description: >-
  Access mAI on any device — browser, desktop (macOS/Windows), or mobile
...
mAI runs wherever you work — browser, desktop, or phone. Sign in once and your Agents, Pages, and Memory stay in sync across every device.
...
**Best for:** Quick access, trying mAI before installing, or using it on shared / restricted machines.
...
Sign in with your mAI account to access Agents and conversations on the go.
