---
title: Using the SambaNova API Key in mAI
description: >-
  Learn how to configure and use SambaNova models in mAI, obtain your API
...
# Using SambaNova in mAI

<Image alt={'Using SambaNova in mAI'} cover src={'/blog/assetsd9e6fe2197270f0f774accd6abcf4019.webp'} />
...
This guide will walk you through how to use SambaNova in mAI:
...
<Steps>
  ...
  ### Step 2: Configure SambaNova in mAI

  - Go to the `App Settings` section in mAI
...
You're now ready to start chatting with models powered by SambaNova in mAI.
