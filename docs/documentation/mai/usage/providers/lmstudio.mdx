...
# Using LM Studio in mAI

<Image alt={'Using LM Studio in mAI'} cover src={'/blog/assets28749075f0c4d62c1642694a4ed9ec08.webp'} />
...
This guide will walk you through how to use LM Studio within mAI:
...
<Steps>
  ...
  ### Step 5: Connect LM Studio to mAI

  - Go to the `App Settings` in mAI and open the `AI Service Providers` section
...
And that’s it! You’re now ready to use models running in LM Studio directly within mAI.
