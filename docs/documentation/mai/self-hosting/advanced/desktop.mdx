---
title: Automatic Synchronization with mAI Desktop
description: Configure mAI Desktop for a synchronized experience
tags:
  - mAI
...
# Automatic Synchronization with mAI Desktop

mAI Desktop provides users with an enhanced experience while also expanding the capabilities of mAI, allowing users to utilize mAI in offline environments. This document will guide you on how to configure mAI Desktop and connect it to your self-hosted instance.

## System Requirements

mAI Desktop is built using Electron and supports the following operating systems:
...
The version release of mAI Desktop follows this logic:

- **Beta Version**: All merges to the main branch that are automatically released will be created as Beta versions of mAI Desktop.
...
mAI Desktop can connect to your self-hosted mAI instance, allowing you to use your self-hosted configuration on the desktop.
...
If you are deploying mAI using one-click deployment methods (such as Vercel, Railway, etc.), you need to:
...
3. Enter the address of your self-hosted instance (e.g., `https://your-mAI-instance.com`).
...
- Example file names:
  - Apple Silicon: `mAI-Beta-1.83.6-arm64.dmg` or `mAI-Beta-1.83.6-arm64-mac.zip`
  - Intel: `mAI-Beta-1.83.6-x64.dmg` or `mAI-Beta-1.83.6-mac.zip`
