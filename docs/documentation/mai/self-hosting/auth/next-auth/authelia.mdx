---
title: Configuring Authelia Authentication Service for mAI
description: >-
  Learn how to configure Authelia authentication service in mAI, including
  creating a provider, configuring environment variables, and deploying mAI.
...
<Steps>
  ...
  Make sure to replace secret and `redirect_urls` with your own values. Note! The secret configured in Authelia is ciphertext, i.e., a salted hash value. Its corresponding plaintext needs to be filled in mAI later.
