    ...
    <html lang="fr" className={`${inter.variable} ${spaceGrotesk.variable}`} suppressHydrationWarning>
      ...
      >
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem disableTransitionOnChange>
          ...
          <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 pb-32 pt-6 z-10">
            {children}
          </main>

          <footer className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-5xl rounded-3xl md:rounded-full border border-black/10 dark:border-white/10 bg-white/30 dark:bg-slate-900/30 backdrop-blur-md shadow-sm px-4 md:px-8 py-2 md:py-3 flex items-center justify-center transition-all duration-300">
