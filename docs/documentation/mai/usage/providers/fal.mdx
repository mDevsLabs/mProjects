---
title: Using Fal API Key in mAI
description: >-
  Learn how to configure and use the Fal API Key in mAI to generate
...
<Image alt={'Using Fal in mAI'} cover src={'https://hub-apac-1.lobeobjects.space/docs/f253e749baaa2ccac498014178f93091.png'} />

[Fal.ai](https://fal.ai/) is a high-performance inference platform specializing in AI media generation. It offers state-of-the-art image generation and editing models such as FLUX, Seedream, and Qwen Image. This guide will walk you through how to use Fal within mAI:
...
'https://hub-apac-1.lobeobjects.space/docs/499a447e98dcc79407d56495d0305e2a.png'
  ...
  ### Step 2: Configure Fal in mAI

  - Navigate to the `Settings` page in mAI;
...
And that’s it! You’re now ready to create stunning visual content in mAI using Fal’s advanced image generation models.
