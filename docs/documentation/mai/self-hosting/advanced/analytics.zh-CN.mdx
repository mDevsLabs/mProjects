---
title: mAI 数据分析集成服务介绍
description: 了解如何在 mAI 中集成免费/开源的数据统计服务，帮助分析用户使用情况。包括 Vercel Analytics 的设置和使用教程。
tags:
  - mAI
  - 数据分析
  - Vercel Analytics
...
为更好地帮助分析 mAI 的用户使用情况，我们在 mAI 中集成了若干免费 / 开源的数据统计服务，用于收集用户的使用情况，你可以按需开启。
