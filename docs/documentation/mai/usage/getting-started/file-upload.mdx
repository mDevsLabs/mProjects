...
mAI provides comprehensive file upload capabilities, enabling AI agents to access, analyze, and reference documents, images, code, and other files during conversations.
...
mAI includes an integrated file viewer:
...
- Files are stored in your mAI instance
