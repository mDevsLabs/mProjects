...
description: >-
  Monitor and analyze your mAI instance using Grafana dashboards, Prometheus
...
mAI supports advanced observability for self-hosted deployments using open-source tools:
...
This guide will help you set up and use these tools to monitor your mAI instance.
...
2. Start the stack with the correct profile:
   ...
   This will launch Grafana, Prometheus, Tempo, and the otel-collector alongside mAI with Casdoor, Minio, and other advanced services.
...
- Verify Prometheus and Tempo are scraping and receiving data from mAI and otel-collector.
