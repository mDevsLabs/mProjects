---
title: Using InternLM in mAI
description: >-
  Learn how to configure and use your InternLM API Key in mAI to start
...
This guide will walk you through how to use InternLM within mAI.
...
<Steps>
  ...
  ### Step 2: Configure InternLM in mAI
...
You’re all set! You can now start using InternLM-powered models in mAI for conversations and interactions.
