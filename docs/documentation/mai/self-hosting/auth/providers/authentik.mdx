---
title: Configuring Authentik Authentication for mAI
description: >-
  Learn how to configure Authentik SSO for mAI, including creating an OAuth2
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`    | Required | SSO provider for mAI. Use `authentik` for Authentik                       |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authentik and use mAI.
</Callout>
