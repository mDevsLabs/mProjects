---
title: mAI Feature Flags Environment Variables Configuration Guide
description: >-
  Learn how to use environment variables to customize mAI's feature flags,
...
In addition to basic environment variable configuration, mAI also offers feature flags to control whether a feature is enabled globally, or to enable or disable features for specific user groups or environments as needed.
