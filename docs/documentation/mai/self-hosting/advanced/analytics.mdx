---
title: Integrating Data Analytics Services in mAI for User Usage Analysis
description: >-
  Learn how to integrate free/open-source data analytics services in mAI to
...
To better help analyze the usage of mAI users, we have integrated several free/open-source data analytics services in mAI for collecting user usage data, which you can enable as needed.
