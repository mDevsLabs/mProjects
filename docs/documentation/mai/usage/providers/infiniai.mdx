---
title: Using Infini-AI in mAI
description: >-
  Learn how to configure and use Infini-AI's API Key in mAI to enable
...
This guide will walk you through the steps to quickly integrate Infini-AI's capabilities into mAI.
...
<Steps>
  ...
  ### Step 2: Configure the Model Service in mAI

  - Open mAI and go to the "Settings" page
