---
title: Using Ollama in mAI
description: >-
  Learn how to use Ollama in mAI to run large language models locally and
...
<Image alt={'Using Ollama in mAI'} borderless cover src={'/blog/assets17870709/f579b39b-e771-402c-a1d1-620e57a10c75.webp'} />

Ollama is a powerful framework for running large language models (LLMs) locally. It supports a variety of models, including Llama 3.1, Mistral, and more. mAI now integrates seamlessly with Ollama, allowing you to leverage these models directly within your chat interface.

This guide will walk you through how to use Ollama in mAI:

<Video alt={'Full demo of using Ollama in mAI'} height={580} src="/blog/assets28616219/c32b56db-c6a1-4876-9bc3-acbd37ec0c0c.mp4" />
...
<Steps>
  ...
  ### Chat with Local LLMs in mAI

  You can now start chatting with local LLMs in mAI.

  <Image alt="Chatting with llama3 in mAI" height="573" src="/blog/assets28616219/7f9a9a9f-fd91-4f59-aac9-3f26c6d49a1e.webp" />
</Steps>
...
mAI comes pre-configured with popular LLMs like Llama 3.1, Gemma 2, and Mistral. When you select a model for the first time, mAI will prompt you to download it.

<Image alt="mAI prompts to install Ollama model" height="460" src="/blog/assets28616219/4e81decc-776c-43b8-9a54-dfb43e9f601a.webp" />
...
You can configure Ollama settings in mAI under `Settings` -> `AI Providers`. Here, you can set the proxy, model name, and more.

<Image alt={'Ollama provider settings'} height={274} src={'/blog/assets28616219/54b3696b-5b13-4761-8c1b-1e664867b2dd.webp'} />

<Callout type={'info'}>
  To learn how to deploy mAI with Ollama integration, visit [Integrating with Ollama](/en/docs/self-hosting/examples/ollama).
</Callout>
