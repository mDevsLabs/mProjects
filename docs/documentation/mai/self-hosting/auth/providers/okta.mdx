---
title: Configuring Okta Authentication for mAI
description: >-
  Learn how to configure Okta SSO for mAI, including creating an application
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS` | Required | SSO provider for mAI. Use `okta` for Okta                                 |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Okta and use mAI.
</Callout>
