---
title: URL 分享设置参数 - mAI 配置快速设置
description: 了解如何从外部 URL 导入和导出 mAI 的设置参数，包括 keyVaults 和 languageModel，以及参数格式和类型。
tags:
  - URL 分享
  - 设置参数
  - mAI
...
mAI 支持从外部 URL 导入设置参数，以便于快速设置 mAI 的配置。
...
<Callout type={'warning'}>
  mAI 不对 URL 中的设置参数进行正确性校验，也不提供 URL 的加密、解密方法，请谨慎使用。
</Callout>
