---
title: 在 mAI 中使用 Cloudflare Workers AI
description: 学习如何在 mAI 中配置和使用 Cloudflare Workers AI 的 API Key，以便开始对话和交互。
tags:
  - mAI
  - Cloudflare
  - Workers AI
...
# 在 mAI 中使用 Cloudflare Workers AI
...
本文档将指导你如何在 mAI 中使用 Cloudflare Workers AI:
...
<Steps>
  ...
  ### 步骤二：在 mAI 中配置 Cloudflare Workers AI
...
至此你已经可以在 mAI 中使用 Cloudflare Workers AI 提供的模型进行对话了。
